...
const Hotels = () => {
  ...
  const apiUrl7 =
    "http://localhost:5147/api/PublicData/specificHotelDetails?hotelId=11";
  const apiUrl8 =
    "http://localhost:5147/api/PublicData/specificHotelDetails?hotelId=4";
  const apiUrl9 =
    "http://localhost:5147/api/PublicData/specificHotelDetails?hotelId=3";
  const apiUrl6 =
    "http://localhost:5147/api/PublicData/specificHotelDetails?hotelId=6";
  const [hotelData, setHotelData] = useState("");
  const [hotelData2, setHotelData2] = useState("");
  const [hotelData3, setHotelData3] = useState("");
  const [hotelData4, setHotelData4] = useState("");
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(function(response) {
        ...
        setHotelData2(data);
        console.log("Data:", data);
        console.log("stored", hotelData2.hotelId);
      })
      .catch(function(error) {
        console.error("Error:", error);
      });
    ...
    axios
      ...
      .then(function(response) {
        ...
        setHotelData3(data);
        console.log("Data:", data);
        console.log("stored", hotelData3.hotelId);
      })
      .catch(function(error) {
        console.error("Error:", error);
      });
    ...
    axios
      ...
      .then(function(response) {
        ...
        setHotelData4(data);
        console.log("Data:", data);
        console.log("stored", hotelData4.hotelId);
      })
      .catch(function(error) {
        console.error("Error:", error);
      });
    ...
    <div className="example-style">
      ...
      <div className="hotels-data">
        {hotels.map((arr, index) => {
          return (
            <div class="max-w-sm mb-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
      ...
      <div className="p-6" style={{ marginBottom: "200px" }}>
        <div className="float-left w-1/5">{/* <Filter></Filter> */}</div>
