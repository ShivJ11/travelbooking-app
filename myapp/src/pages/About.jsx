      ...
      <section>
        <div class="container px-5 mx-auto">
          <div class="text-center mb-20">
            <span class="mt-6 mb-2 block text-lg font-semibold text-blue-700">
              Our Team
            </span>
            <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
              Meet Our Team
            </h2>
            <p class="text-lg leading-relaxed text-gray-500 sm:text-xl sm:leading-relaxed">
              The passionate individuals behind this app who work tirelessly to
              turn your travel dreams into reality. Get to know the faces behind
              your journey.
            </p>
          </div>
        </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              <div class="text-center">
                ...
                <p class="mb-5 text-sm font-medium text-body-color">React</p>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
              ...
              <div class="text-center">
                <h4 class="mb-2 text-lg font-medium text-dark">Shivam Jain</h4>
                <p class="mb-5 text-sm font-medium text-body-color">.net</p>
                <div class="flex items-center justify-center">
                  <a
                    href="javascript:void(0)"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
              ...
              <div class="text-center">
                <h4 class="mb-2 text-lg font-medium text-dark">Harsh Kasana</h4>
                <p class="mb-5 text-sm font-medium text-body-color">DevOps</p>
                <div class="flex items-center justify-center">
                  <a
                    href="javascript:void(0)"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
