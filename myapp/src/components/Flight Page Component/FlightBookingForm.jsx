      ...
      <div className="flight-form">
        ...
        <form action="" className="flight-input-form">
          ...
          <div onClick={toggleAccordian}>
            ...
            <input type="number" placeholder="Travellers"></input>
          </div>
          {/* {openAccordian && (
            <form className="flight-accordian">
              ...
              <div style={{ display: "flex" }}>
                <p>Child</p>
                <button type="button" onClick={incrementChildCount}>
                  +
                </button>
                <div>{childCount}</div>
                <button type="button" onClick={decrementChildCount}>
                  -
                </button>
              </div>
              <div style={{ display: "flex" }}>
                <p>Infant</p>
                <button type="button" onClick={incrementInfantCount}>
                  +
                </button>
                <div>{infantCount}</div>
                <button type="button" onClick={decrementInfantCount}>
                  -
                </button>
              </div>
            </form>
